...
author: "Eva-Maria Rathner, Sonya Goosen, David Ebert, Mathias Harrer, Sophia Adam, Ann-Marie Küchler, Pim Cuijpers, Ronald C. Kessler, Andreas Schwerdtfeger and Harald Baumeister"
...
```{r}
load("robplot.data.RData")
source("rob.summary.R")
plot <- rob.summary(data = robplot.data)
new.plot <- plot + scale_x_discrete(labels=c("Random_Sequence" = "Random Sequence Generation", 
                                             "Allocation_Concealment" = "Allocation Concealment", 
                                             "Blinding_Participants" = "Blinding (Participants)", 
                                             "Blinding_Personnel" = "Blinding (Personnel)", 
                                             "Incomplete_Data_Dropout" = "Incomplete Data (Dropout)", 
                                             "Incomplete Data_ITT_Analysis" = "Incomplete Data (ITT Analysis)",
                                             "Selective_Outcome_Reporting" = "Selective Outcome Reporting", 
                                             "Similar_Groups" = "Similar Groups", 
                                             "Compliance" = "Compliance", 
                                             "Identical_Post_Timing" = "Identical Post Timing", 
                                             "Co_Interventions" = "Co-Interventions"))
new.plot
